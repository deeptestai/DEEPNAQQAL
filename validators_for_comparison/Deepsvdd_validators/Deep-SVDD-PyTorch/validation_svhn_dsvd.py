...
sys.path.append('/home/vincenzo.riccio/Deep-SVDD-PyTorch/src')
...
min_max = [
       (-9.8109712600708, 11.722309112548828),
       (-11.558295249938965, 11.18669605255127),
       (-12.608600616455078, 12.058191299438477),
       (-11.36137866973877, 9.659506797790527),
       (-11.284592628479004, 11.02198314666748),
...
def validate_and_save_results(root_dir, model_ckpt_path, threshold,objective, output_csv):
    ...
    net.set_network('svhn_LeNet')  # Update network name if needed
...
if __name__ == '__main__':
    root_dir = './generated_images/svhn_test_img'  # Root directory containing subfolders
    ckpt_path = './Deep-SVDD-PyTorch/log/svhn_test/deepSVDD_ckpt_soft_boundary_svhn'  # Model checkpoint
    output_csv = './validation_results_svhn_deepsvdd.csv'  # Output CSV file
    objective =  'one-class'            # 'soft-boundary'
    threshold = 0.0305215                                                 # 0.0026523620557009173 Imagenet                       # Set anomaly score threshold
