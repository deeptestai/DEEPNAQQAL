...
# Updated Global Min and Max
#min_max_overall = [(-0.8826567065619495, 20.108062262467364)] # For Mnist
...
#transform = transforms.Compose([
 ...
 #   transforms.Lambda(lambda x: global_contrast_normalization(x, scale='l1')),
  #  transforms.Normalize(
   #     [min_max_overall[0][0]],[min_max_overall[0][1] - min_max_overall[0][0]]
   # )
#])


min_max = [(-1224.9273681640625, 2757.67919921875)] # For imagenet
...
def validate_and_save_results(root_dir, model_ckpt_path, threshold,objective, output_csv):
    ...
    net.set_network('img_resnet50')  # Update network name if needed
...
if __name__ == '__main__':
    root_dir = './generated_images/imagenet_inputs'  # Root directory containing subfolders
    ckpt_path = './Deep-SVDD-PyTorch/log/imgnt_test/deepSVDD_ckpt_soft_boundary_imgnt'  # Model checkpoint
    output_csv = './validation_results_imgnt_deepsvdd.csv'  # Output CSV file
    objective = 'soft-boundary'
    threshold =  0.0026523620557009173                     #0.3500521183013916  # Set anomaly score threshold
