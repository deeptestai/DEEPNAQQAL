...
if DATASET_NAME == "imagenet":
    ...
    data = create_dataset_dict("experimental_data/TIGvalidity - {DATASET_NAME.upper()}_SURVEY.csv",", dataset_name=DATASET_NAME, question_marks=QM_POLICY)
...
if SAVE_MODEL:
    model_dest_folder = f"./validator_models/{DATASET_NAME}/{QM_POLICY}/test_imagenet"
