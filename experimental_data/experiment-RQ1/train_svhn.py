...
IMG_SIZE = 32
DATASET_NAME = "svhn"
dest_folder = "results/svhn/results_remove/test_svhn"

augment_up_to = args.class_img #minimum samples per class
BATCH_SIZE = args.bs
RANDOM_SEED = args.seed
K_SPLITS = 2 #args.k_splits
SHUFFLE = True
QM_POLICY = args.qm
...
if SAVE_MODEL:
    model_dest_folder = f"/home/vincenzo.riccio/human-feedback-validity-checker-dnn/validator_models/{DATASET_NAME}/{QM_POLICY}/test_llm"
