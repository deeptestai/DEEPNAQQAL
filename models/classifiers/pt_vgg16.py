...
class ImageNet_classifier(nn.Module):
    ...
    def forward(self, x):
        #out = (self.conv1(x))
        #print("PT OUTPUT")
        #block1out = np.copy(out)
        #block1out = np.transpose(block1out, (0, 2, 3, 1))
        #print(block1out[0])
        #print(block1out.shape)
        #exit()
    ...
    def reset_last_layer(self, num_classes=2):
        ...
        self.predictions = nn.Linear(4096, num_classes) 

#import numpy as np
#import tensorflow as tf
#rand_img = np.random.rand(32,32,3).astype('float32')

#device = 'cuda' if torch.cuda.is_available() else 'cpu'
#image2 = np.transpose(tf.expand_dims(rand_img, 0).numpy(), [0, 3, 1, 2])
...
# #print("TO SAVE")
# #print(conv1_w[0])
# #print("final shape conv1 weights")
# #print(conv1_w.shape)
# sd['block1_conv1.weight'] = conv1_w
# #print("AFTER SAVING")
# #print(sd['block1_conv1.weight'][0])
# #print("-------")
